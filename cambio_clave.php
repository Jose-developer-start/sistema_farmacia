					...
					<form action="./controllers/login.php" method="POST">
						...
						<div class="input-group mb-3">
						 	<div class="input-group-prepend">
						  	...
						  	<input type="password" name="clave1" class="form-control" placeholder="Nueva Clave" autocomplete="off" required>
						</div>
						<div class="input-group mb-3">
						 	<div class="input-group-prepend">
						    	<span class="input-group-text" id="basic-addon1">
						  	...
						  	<input type="password" name="clave2" class="form-control" placeholder="Confirmar Clave" autocomplete="off" required>
						</div>
						<button class="btn btn-info" name="cambio_clave_token">Enviar</button>
					</form>	
				</div>
				<div class="col-md-4"></div>
			</div>
